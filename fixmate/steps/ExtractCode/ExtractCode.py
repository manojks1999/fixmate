...
from fixmate.common.context_strategy.context_strategies import ContextStrategies
from fixmate.common.utils.utils import count_openai_tokens, open_with_chardet
...
class ExtractCode(Step):
    ...
    def run(self) -> dict:
        ...
        return dict(files_to_fix=extracted_code_contexts)
